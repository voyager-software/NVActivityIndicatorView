...
final class NVActivityIndicatorAnimationBallSpinFadeLoader: NVActivityIndicatorAnimationDelegate {
    // MARK: Internal
    ...
    private func circleAt(angle: CGFloat, size: CGFloat, origin: CGPoint, containerSize: CGSize, color: UIColor, lineWidth: CGFloat?) -> CALayer {
        ...
        let circle = NVActivityIndicatorShape.circle.layerWith(size: CGSize(width: size, height: size), color: color, lineWidth: lineWidth)
        let frame = CGRect(
